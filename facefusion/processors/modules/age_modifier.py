...
MODEL_SET : ModelSet =\
{
	'styleganex_age':
	{
		'hashes':
		{
			'age_modifier':
			{
				'url': 'https://gh.tryxd.cn/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/styleganex_age.hash',
		...
		'sources':
		{
			'age_modifier':
			{
				'url': 'https://gh.tryxd.cn/https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0/styleganex_age.onnx',
